...
interface PlayerPanelQualityProps {
  drawerPercentage: number;
  navigation?: any;
}
const PlayerPanelQuality = (props: PlayerPanelQualityProps) => {
...
const PlayerQualityPanel = PlayerPanelQuality;
export default PlayerQualityPanel;
