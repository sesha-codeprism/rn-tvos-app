...
/// documented in <code>PlayerListener</code> is not working.
/// \param event An object holding specific event data.
///
/// \param player The player instance which is associated with the emitted event.
///
- (void)onUpdatePlayerState:(_BMPUpdatePlayerStateEvent * _Nonnull)event player:(id <BMPPlayer> _Nonnull)player;
...
@property (nonatomic, readonly, strong) id <_BMPEventSuppressor> _Nonnull eventSuppressor;
@property (nonatomic, readonly) _BMPServiceType type;
- (nonnull instancetype)initWithPlayer:(id <BMPPlayer> _Nonnull)player eventSuppressor:(id <_BMPEventSuppressor> _Nonnull)eventSuppressor logger:(id <_BMPLogger> _Nonnull)logger OBJC_DESIGNATED_INITIALIZER;
- (void)emitPlayerEvent:(BMPPlayerEvent * _Nonnull)event;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic, readonly) BOOL isPictureInPicture;
@property (nonatomic) BOOL showSkipControls SWIFT_AVAILABILITY(tvos,unavailable) SWIFT_AVAILABILITY(ios,introduced=14.0);
- (nonnull instancetype)initWithPlayerView:(BMPPlayerView * _Nonnull)playerView pictureInPictureController:(AVPictureInPictureController * _Nonnull)pictureInPictureController pictureInPictureConfig:(BMPPictureInPictureConfig * _Nonnull)pictureInPictureConfig uiEventEmitter:(id <_BMPUserInterfaceEventEmitter> _Nonnull)uiEventEmitter OBJC_DESIGNATED_INITIALIZER;
- (void)enterPictureInPicture;
- (void)exitPictureInPicture;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
- (nonnull instancetype)initWithAvPlayerLayer:(AVPlayerLayer * _Nonnull)avPlayerLayer uiEventEmitter:(id <_BMPUserInterfaceEventEmitter> _Nonnull)uiEventEmitter playerView:(BMPPlayerView * _Nonnull)playerView OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic, readonly) BOOL isSeeking;
@property (nonatomic, readonly) _BMPServiceType type;
- (nonnull instancetype)initWithCastManager:(BMPBitmovinCastManager * _Nonnull)castManager castMessagingService:(id <_BMPCastMessagingService> _Nonnull)castMessagingService currentSourceProvider:(id <_BMPCurrentSourceProvider> _Nonnull)currentSourceProvider playlistSourcesProvider:(id <_BMPPlaylistSourcesProvider> _Nonnull)playlistSourcesProvider timeService:(id <_BMPTimeService> _Nonnull)timeService playerEventEmitter:(id <_BMPPlayerEventEmitter> _Nonnull)playerEventEmitter OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic, unsafe_unretained) id <BMPPlayer> _Nonnull player;
...
SWIFT_CLASS_NAMED("_UpdatePlayerStateEvent")
@interface _BMPUpdatePlayerStateEvent : BMPPlayerEvent
@property (nonatomic, readonly, copy) NSString * _Nonnull name;
@property (nonatomic, readonly, copy) NSDictionary<NSString *, NSString *> * _Nonnull stateValues;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)addStatePropertyWithName:(NSString * _Nonnull)jsPropertyName value:(NSString * _Nonnull)value;
@end


/// Builds a <code>UpdatePlayerStateEvent</code> which will be delegated to the UI bridge to update the AppState there.
/// This is needed to access the current player state which is not yet accessed through synchronous JS <> native calls.
SWIFT_CLASS_NAMED("_UpdatePlayerStateEventBuilder")
@interface _BMPUpdatePlayerStateEventBuilder : NSObject
- (nonnull instancetype)initWithPlayer:(id <BMPPlayer> _Nonnull)player OBJC_DESIGNATED_INITIALIZER;
- (_BMPUpdatePlayerStateEvent * _Nonnull)createStateUpdateEventForPlaybackState SWIFT_WARN_UNUSED_RESULT;
- (_BMPUpdatePlayerStateEvent * _Nonnull)createStateUpdateEventForPlayerReadyState SWIFT_WARN_UNUSED_RESULT;
- (_BMPUpdatePlayerStateEvent * _Nonnull)createStateUpdateEventForTimeShiftState SWIFT_WARN_UNUSED_RESULT;
- (_BMPUpdatePlayerStateEvent * _Nullable)createStateUpdateEventForEvent:(id <BMPEvent> _Nullable)event SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
